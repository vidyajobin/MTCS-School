  ...
  return (
    ...
    <header className="header">
      <div className="header-section">
        ...
        <p>
          <span className="icon-container"><i className="fas fa-map-marker-alt"></i></span>
          Puliyanam P.O, Angamaly, Ernakulam, Kerala-683572
        </p>
      </div>
      <div className="header-section">
        <p><i className="fas fa-paper-plane"></i>Email: mountthabore@yahoo.com</p>
      </div>
      <div className="header-section">
      ...
      <Navbar bg="light" data-bs-theme="light">
        <Container>
          ...
          <Nav className="ms-auto">
            ...
            <Nav.Link as={Link} to="/schoolfees">School Fees</Nav.Link>
